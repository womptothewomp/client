...
local weaponMeta = loadstring(game:HttpGet("https://raw.githubusercontent.com/VelocityCheats/VanilaV2/main/Bedwars/weaponMeta", true))()
local Functions = loadstring(game:HttpGet("https://raw.githubusercontent.com/VelocityCheats/VanilaV2/main/Bedwars/Functions.lua", true))()
local Utilities = loadstring(game:HttpGet("https://raw.githubusercontent.com/VelocityCheats/VanilaV2/main/Libraries/utils.lua", true))()
...
if not isfile("Polaris/games/"..game.PlaceId..".lua") then
	writefile("Polaris/games/"..game.PlaceId..".lua")
end
